  ...
  */
  ...
  if ((!isset($_SESSION['securityToken']) || !isset($_POST['securityToken'])) || ($_SESSION['securityToken'] !== $_POST['securityToken'])) {
    ...
    $check_customer_query = "SELECT customers_id, customers_firstname, customers_lastname, customers_password,
                                    ...
                                    customers_authorization, customers_referral, customers_group_pricing
    ...
    // *** end Encrypted Master Password by stagebrace ***
        ...
        $_SESSION['customer_zone_id'] = $check_country->fields['entry_zone_id'];
				...
				$_SESSION['customer_is_in_group_pricing'] = in_array($check_customer->fields['customers_group_pricing'], array(8,9)) ? true : false;
